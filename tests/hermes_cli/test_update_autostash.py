...
def _setup_update_mocks(monkeypatch, tmp_path):
    ...
    # Keep the module-level test doubles below alive across the update tail.
    # Production purges cached Hermes modules after pulling new source, which
    # is correct in a live update but would re-import the real gateway helpers
    # and let this stash-only test inspect/restart the host gateway.
